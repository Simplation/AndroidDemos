package com.simplation.androiddemos.function_summary.ifkey_sdk.voice.IdentifyGroup;
...
public class GroupManagerActivity extends Activity implements OnClickListener, AdapterView.OnItemClickListener {
	...
	private void initLayout() {
		...
		// 输入组id
		etGroupId = (view.findViewById(R.id.edt_group_id));
		// 输入组名称
		etGroupName = (view.findViewById(R.id.edt_group_name));
		mToast = Toast.makeText(this, "", Toast.LENGTH_SHORT);

		// 绑定XML中的ListView，作为Item的容器
		ListView list = findViewById(R.id.lv_my_group);
	...
	private void startProgress(String msg) {
		...
		mProDialog.show();
		(findViewById(R.id.group_manager_layout)).setEnabled(false);
	}
	...
	private void stopProgress() {
		...
		(findViewById(R.id.group_manager_layout)).setEnabled(true);
	}
