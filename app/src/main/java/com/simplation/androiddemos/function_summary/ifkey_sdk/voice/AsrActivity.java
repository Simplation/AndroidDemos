...
/**
 * 语法识别
 * desc: 读取文本定义的规则，通过语音来识别并显示
 */
public class AsrActivity extends AppCompatActivity implements View.OnClickListener {

    private static String TAG = AsrActivity.class.getSimpleName();
    // 语音识别对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化识别对象
        mAsr = SpeechRecognizer.createRecognizer(AsrActivity.this, mInitListener);
    ...
    protected void onResume() {
        //移动数据统计分析
        FlowerCollector.onResume(AsrActivity.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(AsrActivity.this);
        super.onPause();
    }
}
