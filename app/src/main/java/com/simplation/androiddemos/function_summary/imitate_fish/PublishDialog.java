...
public class PublishDialog extends Dialog {
    ...
    private void init() {
        ...
        mPublishDialogLlBt.setOnClickListener(v -> {
            outDia();
            //点击底部按钮区域退出dialog
        });

        mPublishMainRlmian.setOnClickListener(v -> {
            outDia();
            //设置点击非控件区域也将退出dialog
        });
...
//这三个方法设置了三个控件的点击事件并返回一个PublishDialog 这里需要一个OnClickListener的参数
    ...
    PublishDialog setFabuClickListener(View.OnClickListener clickListener) {
        mPublishDialogFabu.setOnClickListener(clickListener);
        return this;

    }

    PublishDialog setHuishouClickListener(View.OnClickListener clickListener) {
        mPublishDialogHuishou.setOnClickListener(clickListener);
        return this;

    }

    PublishDialog setPingguClickListener(View.OnClickListener clickListener) {
