 ...
 * 唤醒
 */
public class WakeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initUi() {
        ...
        textView = findViewById(R.id.txt_show_msg);
        tvThresh = findViewById(R.id.txt_thresh);
        ...
        RadioGroup group = findViewById(R.id.ivw_net_mode);
    ...
    private String getResource() {
        final String resPath = ResourceUtil.generateResourcePath(WakeActivity.this, ResourceUtil.RESOURCE_TYPE.assets, "ivw/" + getString(R.string.app_id) + ".jet");
