...
//        val a =
//            context!!.theme.obtainStyledAttributes(attrs, R.styleable.SignatureView, 0, 0)
//        // Configurable parameters
//        try {
//            mMinWidth =
...
//
//    /**
//     * Set the pen color from a given resource. If the resource is not found, [Color.BLACK] is assumed.
//     *
//     * @param colorRes
//     * the color resource.
//     */
...
//        if (mPoints!!.size > 2) { // To reduce the initial lag make it work with 3 mPoints
...
//            mSignatureBitmapCanvas = mSignatureBitmap as Canvas
//        }
//    }
//
