...
public class ResultIdentifyActivity extends Activity implements OnClickListener {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            final TextView tx_number = view.findViewById(R.id.identify_item_number);
            final TextView tx_user = view.findViewById(R.id.identify_item_user);
            final TextView tx_score = view.findViewById(R.id.identify_item_score);
            JSONObject obj;
            try {
