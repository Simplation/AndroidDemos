...
public class TracingActivity extends BaseActivity implements View.OnClickListener, SensorEventListener {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_trace:
                if (trackApp.isTraceStarted()) {
                    BaseApplication.mClient.stopTrace(BaseApplication.mTrace, traceListener);//停止服务
                } else {
                    BaseApplication.mClient.startTrace(BaseApplication.mTrace, traceListener);//开始服务
                }
                break;
            ...
            case R.id.btn_gather:
                if (trackApp.isGatherStarted()) {
                    ...
                    BaseApplication.mClient.startGather(traceListener);//开启采集
                }
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data.hasExtra("locationMode")) {
            ...
            BaseApplication.mClient.setLocationMode(locationMode);//定位模式
        }
        ...
        if (data.hasExtra("gatherInterval") && data.hasExtra("packInterval")) {
            ...
            BaseApplication.mClient.setInterval(gatherInterval, packInterval);//设置频率
        }
