...
import com.simplation.androiddemos.function_summary.ifkey_sdk.result.xml.XmlResultParser;
import com.simplation.androiddemos.function_summary.ifkey_sdk.speech.setting.IseSettings;
...
public class IseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static String TAG = IseActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIse = SpeechEvaluator.createEvaluator(IseActivity.this, null);
        initUI();
        setEvaText();
    }
    ...
    private void initUI() {
        ...
        mEvaTextEditText = findViewById(R.id.ise_eva_text);
        mResultEditText = findViewById(R.id.ise_result_text);
        mIseStartButton = findViewById(R.id.ise_start);
        ...
        mToast = Toast.makeText(IseActivity.this, "", Toast.LENGTH_LONG);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.image_ise_set:
                Intent intent = new Intent(IseActivity.this, IseSettings.class);
    ...
    protected void onResume() {
        // 开放统计 移动数据统计分析
        FlowerCollector.onResume(IseActivity.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(IseActivity.this);
        super.onPause();
    }
}
